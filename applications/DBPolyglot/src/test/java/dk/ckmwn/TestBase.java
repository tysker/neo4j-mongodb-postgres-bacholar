...
public class TestBase {
    ...
    private static GenericContainer mongoContainer, neoContainer;
    protected static MongoClient mongoClient;
    protected static Driver neoDriver;

    protected static ArticleManagement am;
    protected static KeywordManagement km;
    protected static StockManagement sm;

    private static String mongoHost = "localhost";
    private static String neoHost = "localhost";
    private static int mongoPort = 27017;
    private static int neoPort = 7474;
